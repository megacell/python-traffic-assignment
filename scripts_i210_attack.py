...
def process_I210_net():
    process_net('data/I210_attack_Sketch_net.csv', 'data/I210_attack_net.csv')
...
def I210_path_choices(alphas):
    ...
    for i, alpha in enumerate(alphas):
        f_r = np.loadtxt(
            'data/I210_attack/test_{}.csv'.format(int(alpha * 100)),
    ...
    np.savetxt('data/I210_attack/path_flows_routed.csv', out, delimiter=',',
